...
\item[student?] Whether the dependent is a student.
\item[disabled?] Whether the dependent is fully disabled.
\end{description}
...
\item[start\_principal] The starting principal of the mortgage on this property
for the year.
\item[end\_principal] The ending principal of the mortgage on this property for
the year.
\item[taxes] Property taxes paid on this property this year.
\item[origination\_date] Date that the mortgage on this property originated.
\end{description}
